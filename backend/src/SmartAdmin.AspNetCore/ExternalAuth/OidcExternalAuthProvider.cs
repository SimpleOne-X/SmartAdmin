...
/// <summary>
/// 内核内置的标准 OIDC 授权码登录 provider。通吃 Keycloak / Entra ID / Authing / Auth0 等
...
public class OidcExternalAuthProvider : IExternalAuthProvider
{
    ...
    /// <summary>按 <paramref name="options"/> 构造一个 provider 实例。<paramref name="allowHttpMetadata"/> 仅供开发环境放行 http 元数据地址,生产恒需 https。</summary>
