...
/// 会话标识:写入令牌 claim,作为在线用户列举与强退的稳定锚点——
/// 强退即作废该 SessionId,令牌未到期也立刻失效。
/// </param>
/// <param name="IsSuperAdmin">
/// 超管标志:写入令牌 claim,授权管道第一步"超管直接放行"据此判断,免每请求查库。
/// </param>
/// <param name="OrgId">
...
/// <summary>
/// 一次签发的令牌对:AccessToken 短期、不落库;RefreshToken 长期、服务端存哈希、支持轮换吊销。
/// </summary>
