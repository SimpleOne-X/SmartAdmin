export default {
  ...
  config: {
    ...
    externalAuth: {
      ...
      notConfiguredTip:
        'Not registered on this deployment (package/secrets missing). Cannot show on login.',
  ...
  tenant: {
    ...
    code: 'Tenant Code',
    name: 'Tenant Name',
    codePlaceholder: 'e.g. acme, cannot be changed after creation',
    contactName: 'Contact',
    contactPhone: 'Contact Phone',
    expireTime: 'Expires At',
    isolationMode: 'Isolation Mode',
    isolationModeShared: 'Shared database',
    isolationModeSharedDesc:
      'Shares the main database with other tenants, isolated by filtering on TenantId. The only option available in phase 1.',
    isolationModeStandalone: 'Standalone database',
    isolationModeStandaloneDesc:
      "This tenant's business data is physically isolated to its own connection string; org structure, users and permissions still live in the shared database (hybrid mode).",
    isolationModePhase2: 'Coming in phase 2',
    initialAdmin: 'Initial Administrator',
    adminAccount: 'Admin Account',
    adminAccountPlaceholder: "This tenant's first login account",
    adminPassword: 'Admin Password',
    adminPasswordPlaceholder: 'Must be changed on first login',
    remark: 'Remark',
    codeRequired: 'Please enter the tenant code',
    nameRequired: 'Please enter the tenant name',
    adminAccountRequired: 'Please enter the admin account',
