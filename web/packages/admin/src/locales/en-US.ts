export default {
  ...
  role: {
    ...
    apiOnlyHint: 'API only, not shown in the menu',
    grantSearch: 'Search directories, pages or buttons',
    grantSearchClear: 'Clear search',
    grantSelectAll: 'Select all in "{name}"',
    noButtons: 'No button permissions',
    grantNoMatch: 'No matching permissions',
    grantNoMatchElsewhere:
      '{count} directory(ies) match in other apps. Switch the app above to view them.',
    grantNoMenus: 'No menus in this app',
