...
改后端代码前后对着这份清单核一遍，每条都是内核里已落地的硬规则。想知道某条为什么这么定，点链接看对应那页的详解。更完整的正反例见仓库 [`docs/coding-standards.md`](https://github.com/SmartCode-X/SmartAdmin/blob/main/docs/coding-standards.md)。
